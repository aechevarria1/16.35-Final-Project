...
public class TestFirstRunnerController {
	...
	double[] pose = { 0, 0, 0 };
	 double input_speed = 0;
	    ...
	    FirstRunnerController rc = new FirstRunnerController(sim, current_v, next_runner);
	    		
    }


    public static void main(String[] args){
	org.junit.runner.JUnitCore.main(TestFirstRunnerController.class.getName());
    }
}
