...
public class TestLastRunnerController {
	...
	double[] pose = { 0, 0, 0 };
	 double input_speed = 0;
	    ...
	    LastRunnerController rc = new LastRunnerController(sim, current_v, next_runner, prev_runner, comp_runner);
	    		
    }


    public static void main(String[] args){
	org.junit.runner.JUnitCore.main(TestLastRunnerController.class.getName());
    }
}
